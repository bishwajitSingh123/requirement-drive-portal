...
class jobAdvertForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "deadline": forms.DateInput(attrs={"placeholder":"Date", "class":"form-control", "type":"date"}, format='%Y-%m-%d'),
            "skills": forms.TextInput(attrs={"placeholder":"Comma saperated skills", "class":"form-control"}),
